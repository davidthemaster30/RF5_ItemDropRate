...
public class RF5ItemDropRate : BasePlugin
{
    ...
    {
        ItemDropRatePatch.MonsterItemDrops = Config.Bind(PluginConfigSection, nameof(ItemDropRatePatch.MonsterItemDrops), 5, new ConfigDescription("Base monster item drop rate multiplier.", new AcceptableValueRange<int>(1, 50)));
        ItemDropRatePatch.MonsterItemDrops.SettingChanged += ItemDropRatePatch.OnSettingChanged;
        ItemDropRatePatch.MonsterBonusItemDrops = Config.Bind(PluginConfigSection, nameof(ItemDropRatePatch.MonsterBonusItemDrops), 5, new ConfigDescription("Bonus monster item drop rate multiplier.", new AcceptableValueRange<int>(1, 50)));
        ItemDropRatePatch.MonsterBonusItemDrops.SettingChanged += ItemDropRatePatch.OnSettingChanged;
        ItemDropRatePatch.MonsterSealItemDrops = Config.Bind(PluginConfigSection, nameof(ItemDropRatePatch.MonsterSealItemDrops), 5, new ConfigDescription("Sealed monster item drop rate multiplier.", new AcceptableValueRange<int>(1, 50)));
